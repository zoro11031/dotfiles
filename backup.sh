...
cp -R /etc/systemd/system/backup-git.timer /home/petergriffin/Documents/dotfiles/system/systemd
cp -R /etc/systemd/system/backup-git.service /home/petergriffin/Documents/dotfiles/system/systemd
