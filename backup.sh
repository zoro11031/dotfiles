...
cp -R /etc/systemd/system/backup-git.timer /home/petergriffin/Documents/dotfiles/etc/system/systemd
cp -R /etc/systemd/system/backup-git.service /home/petergriffin/Documents/dotfiles/etc/system/systemd
